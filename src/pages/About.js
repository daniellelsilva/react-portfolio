          ...
          <div className="about-header-text-skills" >
            ...
            <div className="about-text-skills">
              <section className="about-text">
                ...
                <p className="about-text-p about-text-p-3">Sou desenvolvedora <span>front-end</span> e atuo como estagiária de Engenharia de Software na <span>Inteligov</span>, mas continuo estudando na Trybe com o objetivo de me tornar full stack.</p>
